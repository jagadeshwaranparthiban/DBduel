...
const questions: Question[] = [
  { 
    id: 1, 
    text: "Retrieve all books that have more than 50 copies in stock.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
  ...
  { 
    id: 2, 
    text: "Find the most expensive book in the bookstore.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
  ...
  { 
    id: 3, 
    text: "Get the total number of books sold.",
    schema: `Table orders {
  id INT [pk]
  book_id INT [fk]
  customer_id INT [fk]
  ...
  { 
    id: 4, 
    text: "List all customers who have placed an order.",
  ...
  { 
    id: 5, 
    text: "Retrieve all books written by a specific author.",
...
Table books {
  ...
  { 
    id: 6, 
    text: "Find the second highest priced book in the store.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
  ...
  { 
    id: 7, 
    text: "Get the author who has written the most books.",
    schema: `Table authors {
  id INT [pk]
  name VARCHAR
}
...
Table books {
  ...
  { 
    id: 8, 
    text: "Count the number of unique book titles in the store.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
  ...
  { 
    id: 9, 
    text: "Retrieve all books published before the year 2000.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
  ...
  { 
    id: 10, 
    text: "Get the average price of all books in the store.",
    schema: `Table books {
  id INT [pk]
  title VARCHAR
  author_id INT [fk]
